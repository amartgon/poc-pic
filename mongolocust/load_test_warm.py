...
MIN_DATE = datetime.fromisoformat('2022-10-17T00:00:00')
MAX_DATE = datetime.fromisoformat('2023-04-15T00:00:00')
MAX_EQUIPMENT = 37155
...
class MongoSampleUser(MongoUser):
    ...
    def on_start(self):
        ...
        _, self.collection = self.ensure_collection(DEFAULTS['COLLECTION_NAME'], [], pymongo.read_preferences.Nearest())
